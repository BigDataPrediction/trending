...
public class TrendingTopology
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        MongoCappedCollectionSpout mongoSpout = new MongoCappedCollectionSpout(ConfigUtility.getString(conf, "mongo.input.url"),
                ConfigUtility.getString(conf, "mongo.collection.input"));
        ...
        builder.setBolt(
                totalsavetomongoId,
                new MongoWriterBolt(ConfigUtility.getString(conf, "mongo.output.url"), ConfigUtility.getString(conf, "mongo.db.output"),
                        ConfigUtility.getString(conf, "mongo.colloection.output"))).shuffleGrouping(totalRankerId);
