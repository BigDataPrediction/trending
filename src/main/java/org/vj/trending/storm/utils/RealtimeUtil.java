 ...
 */
package org.vj.trending.storm.utils;
...
public class RealtimeUtil
{
     ...
     */
    public static void submitStormTopology(String topologyName, Config conf, TopologyBuilder builder) throws AlreadyAliveException,
